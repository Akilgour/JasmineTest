    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        SaleHeaderId = c.Int(nullable: false, identity: true),
                        CustomerFirstName = c.String(),
                        CustomerSecondName = c.String(),
                        Address = c.String(),
                    })
                .PrimaryKey(t => t.SaleHeaderId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SaleItems", "SaleHeaderId", "dbo.SaleHeaders");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropIndex("dbo.AspNetUserLogins", new[] { "UserId" });
            DropIndex("dbo.AspNetUserClaims", new[] { "UserId" });
            DropIndex("dbo.AspNetUsers", "UserNameIndex");
            DropIndex("dbo.SaleItems", new[] { "SaleHeaderId" });
